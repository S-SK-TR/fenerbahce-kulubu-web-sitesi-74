...
- `CLAUDE.md` dosyasındaki `Fenerbahçe Kulübü Web Sitesi`, `Fenerbahçe Kulübü Web Sitesi — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
